    ...
    public function run()
    {
        DB::table('locations')->insert([
            ...
            [
                ...
                'zip_code' => '34, 35, 36, 37',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'name' => 'Geylang, Eunos',
                'zip_code' => '38, 39, 40, 41',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
                'name' => 'Katong, Joo Chiat, Amber Road',
                'zip_code' => '42, 43, 44, 45',
                'created_at' => Carbon::now()->format('Y-m-d H:i:s'),
                'updated_at' => Carbon::now()->format('Y-m-d H:i:s'),
            ],
            [
